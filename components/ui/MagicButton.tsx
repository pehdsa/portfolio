...
function MagicButton(props: MagicButtonProps) {
    return (
        <button { ...props } className={ `relative inline-flex w-full h-12 overflow-hidden rounded-lg p-[1px] focus:outline-none ${ props.className }`}>
            ...
            <span className={`gap-2 inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg bg-slate-950 px-7 py-1 text-sm font-medium text-white backdrop-blur-3xl z-20 ${ props.otherclasses }`}>
